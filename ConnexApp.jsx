...
function parseWhatsAppText(textContent) {
...
function enrichProfiles(parsedChat) {
...
function analyzeNetwork(profiles) {
...
function normLoc(loc) { return loc ? (LOC_MAP[loc.toLowerCase()] || loc) : null; }

function generateSuggestions(profiles) {
  const suggestions = [];
...
function getDMStrategy(profiles) {
